...
sub do_blast_1pass {
  ...
  system ("$blastall -seg yes -query $Fld[0] -db $Fld[1] -num_descriptions $Fld[3] -num_alignments $Fld[3] -matrix $matrix -dbsize 5000000 -outfmt 5 | ./$blastParser $score_cutoff > $Fld[4]");
}
...
sub do_blast_2pass {
	...
	system("date");
	open FHR, "$blastall -comp_based_stats 3 -seg yes -query $Fld[0] -db $Fld[1] -num_descriptions $Fld[3] -num_alignments $Fld[3] -matrix $matrix -dbsize 5000000 -outfmt 5 | ./$blastParser $score_cutoff|";
	...
	foreach $aQuery (keys % theHits) {
		...
		system ("$blastall -comp_based_stats 0 -seg no -query $tmpi -db $tmpd -num_descriptions $Fld[3] -num_alignments $Fld[3] -matrix $matrix -dbsize 5000000 -outfmt 5 | ./$blastParser $score_cutoff >> $Fld[4]");
	}
